...
public class fragment_recomendations extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((TextView) v.findViewById(R.id.infoText)).setText(HtmlCompat.fromHtml(getContext().getString(R.string.recomend_string), HtmlCompat.FROM_HTML_MODE_LEGACY), TextView.BufferType.SPANNABLE);
